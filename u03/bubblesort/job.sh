...
#!!!!!!! CHANGE port !!!!!!!! (value submitted through environment variable when calling this script)
# free socket port to use for communication between server and client
export PIN_ON_SOCKET=$PORT
#e.g. 14423

#!!!!!!! CHANGE program name !!!!!!!! (values submitted through environment variables when calling this script)
